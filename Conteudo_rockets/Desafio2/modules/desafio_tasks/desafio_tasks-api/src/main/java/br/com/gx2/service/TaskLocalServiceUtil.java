 ...
 * <code>br.com.gx2.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.gx2.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Task createTask(
		...
		return getService().createTask(
			title, description, dueDate, completed, serviceContext);
	}
	...
	public static Task getTaskById(long taskId) throws PortalException {
		return getService().getTaskById(taskId);
	}
	...
	public static Task updateTask(
			...
			java.util.Date dueDate, boolean completed,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().updateTask(
			taskId, title, description, dueDate, completed, serviceContext);
	}
